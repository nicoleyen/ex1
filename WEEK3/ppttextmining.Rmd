---
title: "PPT TEXT MINING"
output: html_document
---
# PTT EuropeTravel 歐洲旅遊版分析

## 網路爬蟲
下載PTT版上的文章
1. 用老師的範本"pttTestFunction.R"下載
2. 選擇頁數範圍id=c(頁數:頁數)
3. URL = paste0("https://www.ptt.cc/bbs/欲分析的版/index", id, ".html")
```{r}
source('pttTestFunction.R')
id = c(1948:1950)
URL = paste0("https://www.ptt.cc/bbs/EuropeTravel/index", id, ".html")
...
from <- 1948
to   <- 1950
prefix = "https://www.ptt.cc/bbs/EuropeTravel/index"
...
利用所有文章的網址去抓所有文章內文, 並解析出文章的內容並依照 page 合併儲存
...
>
> 在歐洲旅遊版中，
> 發文時間:集中在晚上7:00~11:00
> 常出現的關鍵字為"退稅"，對於"直飛"，相關交通資訊，及景點的討論也很熱絡，如王宮、天鵝堡

<img src="https://leo-travel.idv.tw/wp-content/uploads/DSC_6746-1.jpg" style="display:block; margin:auto; width:50%;">
